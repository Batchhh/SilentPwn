...
const char* getFrameworkPath() {
    @autoreleasepool {
        ...
        NSString *mainExecutablePath = [appPath stringByAppendingPathComponent:mainBundleName];
...
BOOL editJSONFile(NSString *fileName, void (^editBlock)(NSMutableDictionary *jsonDict)) {
    @autoreleasepool {
        ...
        NSError *error = nil;
        NSData *jsonData = [NSData dataWithContentsOfFile:fullPath options:0 error:&error];
